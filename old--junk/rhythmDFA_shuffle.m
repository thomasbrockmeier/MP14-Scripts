function [ DFA_Exp, S ] = rhythmDFA_shuffle(input)
...
% input fragment.
%
% THIS SCRIPT SHUFFLES THE NOTE ONSETS CF. THE CONTROL CONDITION IN LEVITIN
% ET AL. (2012). SCALING EXPONENTS SHOULD LIE AROUND 0.5
%
% Requires MIRToolbox!
% Requires Chronux!
